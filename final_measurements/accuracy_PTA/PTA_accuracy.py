...
# Function to define which applicant columns to use based on number of applicants
...
# Function to filter out specific companies from the test vectors
...
# Function to calculate TP, FP, TN, and FN based on the recommendations
...
# Function to run accuracy metrics for all combinations and save to individual files
def run_accuracy_metrics_for_all_combinations():
...
if __name__ == "__main__":
    try:
        run_accuracy_metrics_for_all_combinations()
    except Exception as e:
